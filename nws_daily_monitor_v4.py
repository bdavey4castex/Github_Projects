#!/usr/bin/env python3
"""
NWS Daily Temperature Monitor v4.0
...
OUTPUT_DIR = SCRIPT_DIR / "daily_highs"
...
def create_charts(ws, city_name: str):
    ...
    high_chart.y_axis.majorGridlines = ChartLines()
    ...
    # Y-axis gridlines and labels
    low_chart.y_axis.majorGridlines = ChartLines()
...
def main():
    ...
    logger.info("=" * 70)
    logger.info("ForecastEx NWS Daily Temperature Monitor v4.0")
    ...
    send_alert(
        "Monitor Started",
        f"NWS Temperature Monitor v4.0 has started.\n"
